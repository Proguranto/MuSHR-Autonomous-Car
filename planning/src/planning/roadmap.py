...
class Roadmap(object):
    ...
    def check_weighted_edges_validity(self, weighted_edges):
        ...
        valid_edges = np.array([self.check_edge_validity(int(u), int(v)) for u, v in zip(weighted_edges[:, 0], weighted_edges[:, 1])], dtype=bool)
        weighted_edges = weighted_edges[valid_edges]
        # END QUESTION 1.3
